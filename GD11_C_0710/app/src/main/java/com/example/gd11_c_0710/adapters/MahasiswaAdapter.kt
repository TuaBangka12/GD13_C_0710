package com.example.gd11_c_0710.adapters
...
import com.example.gd11_c_0710.AddEditActivity
import com.example.gd11_c_0710.MainActivity
import com.example.gd11_c_0710.R
        ...
        holder.btnDelete.setOnClickListener{
            ...
            materialAlertDialogBuilder.setTitle("Konfirmasi")
                ...
                .setPositiveButton("Hapus"){_,_ ->
                    if(context is MainActivity) mahasiswa.id?.let { it1 -> context.deleteMahasiswa(
                        it1
                    )
                    }
                } .show()
